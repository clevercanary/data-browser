...
export const AnvilHeaderStory = HeaderTemplate.bind({});
AnvilHeaderStory.args = {
...
export const HCAHeaderStory = HeaderTemplate.bind({});
HCAHeaderStory.args = {
...
export const LungMapHeaderStory = HeaderTemplate.bind({});
LungMapHeaderStory.args = {
  authenticationEnabled: false,
  logo: {
    alt: "LungMap",
    height: 32,
