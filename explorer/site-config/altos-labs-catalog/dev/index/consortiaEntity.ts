import { AltosLabsCatalogConsortium } from "../../../../app/apis/catalog/altos-labs-catalog/common/entities";
import { buildAltosLabsCatalogConsortia } from "../../../../app/apis/catalog/altos-labs-catalog/common/utils";
 ...
 */
export const consortiaEntity: EntityConfig<AltosLabsCatalogConsortium> = {
  detail: {
    staticLoad: true,
    tabs: [],
    top: [],
  ...
  } as ListConfig<AltosLabsCatalogConsortium>,
  route: "consortia",
  staticLoad: true,
  tsv: {
    builderFn: buildAltosLabsCatalogConsortia,
